...
<body>
  <header class="header">
    ...
    <nav class="nav-items">
      <a href="#">WELCOME <%out.println(request.getAttribute("uname")); %></a>
  ...
  <main>
    <div class="intro">
      ...
      <p>I am a Full Stack developer and I love to Develops websites.</p>
    </div>
    ...
    <div class="about-me">
      ...
      <img src="https://img.freepik.com/free-vector/colourful-illustration-programmer-working_23-2148281410.jpg?w=740&t=st=1694677503~exp=1694678103~hmac=90976356a07202a7355b42bee0047e4916d6bf7025f7afe6978f60d0ae994b12" alt="me">
    </div>
  </main>
  <footer class="footer">
    ...
    <div class="bottom-links">
      ...
      <div class="links">
        ...
        <a href="https://www.facebook.com/javabykiran/" target="_blank"><i class="fab fa-facebook"></i></a>
        <a href="https://twitter.com/javabykiran?lang=en" target="_blank"><i class="fab fa-twitter"></i></a>
        <a href="https://www.instagram.com/javabykiran/?hl=en" target="_blank"><i class="fab fa-instagram"></i></a>
      </div>
    </div>
  </footer>
</body>
